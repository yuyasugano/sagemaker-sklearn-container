...
* __gradient-boost__: The directory that contains the application to run in the container. See the next session for details about each of the files.
...
* __input/data/training/iris.csv__: The training data.
